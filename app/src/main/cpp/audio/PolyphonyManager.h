...
constexpr int MAX_POLYPHONY =
    12; // 12 voices for playing 7th chords comfortably
...
private:
  ...
  // Current parameters
  bool mEnabledWaveforms[4] = {false, false, true, false}; // Default Sawtooth
  // Waveform mCurrentWaveform = Waveform::SAWTOOTH; // Removed
